...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities['ca1.policyHolder.com'];
        ...
        const userIdentity = await wallet.get('policyholder1');
        if (userIdentity) {
        ...
        console.error(`Failed to register user "policyholder1": ${error}`);
        process.exit(1);
    }
}
